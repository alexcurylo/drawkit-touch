...
- (DKBezierPath*)			renderingPath;				// returns the actual path to be rendered, at its final location and size in the base coordinate system
...
- (DKAffineTransform*)		containerTransform;			// returns the transform applied by the object's container, if any (otherwise the identity transform)
